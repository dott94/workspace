 ...
 * Postcondition: A connection to the server is established, the connect window is destroyed, the main window's widgets are enabled
 */
void 	   connect_server(GtkWidget* w, gpointer d)
{
	...
	{
		my_str("Could not find the server hostname\n");
		return;
	}
